...
export class Product4Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.finkartService.getAllProducts().subscribe(data=>{
      this.products=data;
      this.product.productName=this.products[3].productName;//change this only
      this.product.productId=this.products[3].productId;//change this only
      this.product.productRate=this.products[3].productRate;//change this only
    });
