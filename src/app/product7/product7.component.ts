  ...
  ngOnInit(): void {
   ...
   // alert(JSON.stringify(this.customer))
    this.finkartService.getAllProducts().subscribe(data=>{
      this.products=data;
      this.product.productName=this.products[6].productName;//change this only
      this.product.productId=this.products[6].productId;//change this only
      this.product.productRate=this.products[6].productRate;//change this only
    });
