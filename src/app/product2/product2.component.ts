...
export class Product2Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.finkartService.getAllProducts().subscribe(data=>{
      this.products=data;
      this.product.productName=this.products[1].productName;//change this only
      this.product.productId=this.products[1].productId;//change this only
      this.product.productRate=this.products[1].productRate;//change this only
    });
