...
export class Product5Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.finkartService.getAllProducts().subscribe(data=>{
      this.products=data;
      this.product.productName=this.products[4].productName;//change this only
      this.product.productId=this.products[4].productId;//change this only
      this.product.productRate=this.products[4].productRate;//change this only
    });
