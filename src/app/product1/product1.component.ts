...
export class Product1Component implements OnInit {
  ...
  //  alert(JSON.stringify(this.customer))
    this.finkartService.getAllProducts().subscribe(data=>{
      this.products=data;
      this.product.productName=this.products[0].productName;//change this only
      this.product.productId=this.products[0].productId;//change this only
      this.product.productRate=this.products[0].productRate;//change this only
    });
