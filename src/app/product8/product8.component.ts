...
export class Product8Component implements OnInit {
  ...
  //  alert(JSON.stringify(this.customer))
    this.finkartService.getAllProducts().subscribe(data=>{
      this.products=data;
      this.product.productName=this.products[7].productName;//change this only
      this.product.productId=this.products[7].productId;//change this only
      this.product.productRate=this.products[7].productRate;//change this only
    });
